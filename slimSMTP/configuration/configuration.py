...
class Configuration(pydantic.BaseModel):
	...
	valid_top_domains :List[str] = [
		...
		'ar', 'arab', 'aramco', 'archi', 'army', 'arpa', 'art', 'arte', 'as',
		...
		'dnp', 'do', 'docs', 'doctor', 'dog', 'domains', 'dot', 'download', 'drive',
		...
		'et', 'etisalat', 'eu', 'eurovision', 'eus', 'events', 'exchange', 'expert',
		...
		'group', 'gs', 'gt', 'gu', 'guardian', 'gucci', 'guge', 'guide', 'guitars',
		'guru', 'gw', 'gy', 'hair', 'hamburg', 'hangout', 'haus', 'hbo', 'hdfc',
		'hdfcbank', 'health', 'healthcare', 'help', 'helsinki', 'here', 'hermes',
		'hgtv', 'hiphop', 'hisamitsu', 'hitachi', 'hiv', 'hk', 'hkt', 'hm', 'hn',
		...
		'in', 'inc', 'industries', 'infiniti', 'info', 'ing', 'ink', 'institute',
		'insurance', 'insure', 'int', 'international', 'intuit', 'investments',
		'io', 'ipiranga', 'iq', 'ir', 'irish', 'is', 'ismaili', 'ist', 'istanbul',
		'it', 'itau', 'itv', 'jaguar', 'java', 'jcb', 'je', 'jeep', 'jetzt',
		'jewelry', 'jio', 'jll', 'jm', 'jmp', 'jnj', 'jo', 'jobs', 'joburg', 'jot',
		'joy', 'jp', 'jpmorgan', 'jprs', 'juegos', 'juniper', 'kaufen', 'kddi', 'ke',
		'kerryhotels', 'kerrylogistics', 'kerryproperties', 'kfh', 'kg', 'kh', 'ki',
		'kia', 'kids', 'kim', 'kinder', 'kindle', 'kitchen', 'kiwi', 'km', 'kn',
		...
		'no', 'nokia', 'northwesternmutual', 'norton', 'now', 'nowruz', 'nowtv',
		'np', 'nr', 'nra', 'nrw', 'ntt', 'nu', 'nyc', 'nz', 'obi', 'observer',
		'office', 'okinawa', 'olayan', 'olayangroup', 'oldnavy', 'ollo', 'om',
		'omega', 'one', 'ong', 'onion', 'onl', 'online', 'ooo', 'open', 'oracle',
		...
		'verisign', 'vermögensberater', 'vermögensberatung', 'versicherung',
		'vet', 'vg', 'vi', 'viajes', 'video', 'vig', 'viking', 'villas', 'vin',
		'vip', 'virgin', 'visa', 'vision', 'viva', 'vivo', 'vlaanderen', 'vn',
		...
		'xfinity', 'xihuan', 'xin', 'xxx', 'xyz', 'yachts', 'yahoo', 'yamaxun',
		'yandex', 'ye', 'yodobashi', 'yoga', 'yokohama', 'you', 'youtube', 'yt',
		'yun', 'za', 'zappos', 'zara', 'zero', 'zip', 'zm', 'zone', 'zuerich',
		'zw', 'ελ', 'ευ', 'бг', 'бел', 'дети', 'ею', 'католик', 'ком', 'қаз',
		'мкд', 'мон', 'москва', 'онлайн', 'орг', 'рус', 'рф', 'сайт', 'срб',
		'укр', 'გე', 'հայ', 'קום', 'بوظبي', 'تصالات', 'رامكو', 'لاردن',
		'لبحرين', 'لجزائر', 'لسعودية', 'لسعوديه', 'لسعودیة', 'لسعودیۃ',
		'لعليان', 'لمغرب', 'ليمن', 'مارات', 'يران', 'یران', 'بارت', 'بازار',
		'بھارت', 'بيتك', 'پاكستان', 'پاکستان', 'ڀارت', 'تونس', 'سودان',
		'سوريا', 'سورية', 'شبكة', 'عراق', 'عرب', 'عمان', 'فلسطين', 'قطر',
		'كاثوليك', 'كوم', 'مصر', 'مليسيا', 'موريتانيا', 'موقع', 'همراه', 'कॉम',
		'नेट', 'भारत', 'भारतम्', 'भारोत', 'संगठन', 'বাংলা', 'ভারত', 'ভাৰত', 'ਭਾਰਤ', 'ભારત',
		'ଭାରତ', 'இந்தியா', 'இலங்கை', 'சிங்கப்பூர்', 'ഭാരതം', 'ලංකා', 'คอม', 'ไทย',
		'ລາວ', 'アマゾン', 'グーグル', 'クラウド', 'コム', 'ストア', 'セール',
		'ファッション', 'ポイント', 'みんな', '世界', '中信', '中国', '中國', '中文网',
		'企', '佛山', '信息', '健康', '八卦', '公司', '公益', '台湾', '台灣', '商城',
		'商店', '商', '嘉里', '嘉里大酒店', '在', '大拿', '天主教', '家電', '广', '微博',
		'慈善', '我你', '手机', '招聘', '政', '政府', '新加坡', '新', '尚', '書籍',
		'机构', '淡', '游', '澳門', '澳', '点看', '移', '机构', '网址', '网店', '网站',
